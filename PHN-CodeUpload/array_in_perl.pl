...
#use of qw operator
@v_qw_array=qw/This is vinoth/; #This will form array with white space as delimi
ter
...
print "\nMaximum index of the array: $#v_max_array"; #CAUTION: It is the maximum index, not the size of the array size is maximum index +1
