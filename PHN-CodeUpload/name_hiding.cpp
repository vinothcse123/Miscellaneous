...
int main()
{
   ...
   // gc.sameNameFunction(); This will fail since already function named sameNameFunction was there. If sameNameFunction i
s not there in grand child, call will be allowed
